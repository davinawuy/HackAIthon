export const communities = [
  {
    id: 'cm-001',
    name: 'Brisbane Uni Global Buddies',
    focus: 'language exchange + newcomer support',
  ...
  {
    id: 'cm-002',
    name: 'West End Student Community Kitchen',
    focus: 'food + friendship + volunteering',
    location: 'West End',
  ...
  {
    id: 'cm-003',
    name: 'Kelvin Grove Creative Collective',
    focus: 'art + music + social confidence',
  ...
  {
    id: 'cm-004',
    name: 'Brisbane Student Career Circle',
    focus: 'mentoring + career networking',
  ...
  {
    id: 'cm-005',
    name: 'River City Sports Starters',
    focus: 'beginner social sports',
  ...
  {
    id: 'cm-006',
    name: 'Faith & Culture Student Connect',
    focus: 'interfaith conversations + wellbeing',
